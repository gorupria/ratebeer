...
RSpec.describe User, type: :model do
  ...
  describe "favorite style" do
    ...
    it "is the one with highest rating" do 
      ...
      beer = FactoryBot.create(:beer)
      beer1 = FactoryBot.create(:beer, name: "beer1", style: "Lager", brewery: brewery)
      beer2 = FactoryBot.create(:beer, name: "beer1", style: "Ipa", brewery: brewery)
      beer3 = FactoryBot.create(:beer, name: "beer1", style: "Ipa", brewery: brewery)
      beer4 = FactoryBot.create(:beer, name: "beer1", style: "Ipa", brewery: brewery)
  ...
  describe "favorite brewery" do
    ...
    it "is the one that produces highest rated beers" do
      ...
      beer2 = FactoryBot.create(:beer, name: "beer1", style: "Ipa", brewery: brewery1)
      beer3 = FactoryBot.create(:beer, name: "beer1", style: "Ipa", brewery: brewery1)
      beer4 = FactoryBot.create(:beer, name: "beer1", style: "Ipa", brewery: brewery2)
